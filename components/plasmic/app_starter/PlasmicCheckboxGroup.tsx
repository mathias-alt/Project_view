...
import Checkbox from "../../Checkbox"; // plasmic-import: jrD-Cp6Lw-Zh/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 2nwicZKtLAKl/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__wj5Q7)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ySst2)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kuJm)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__vMbq2)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
