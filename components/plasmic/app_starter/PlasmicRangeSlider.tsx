...
import SliderThumb from "../../SliderThumb"; // plasmic-import: 3PnH8WRBu7cU/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: fveoP2L8zpkc/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___8BBte)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox___7ZskV)}>
        <div
