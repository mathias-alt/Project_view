...
import Radio from "../../Radio"; // plasmic-import: Y5vJR3YQjrZq/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 21Y9WS4nFryQ/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__jvcwp)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__w7TkS)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio___1FxB3)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__cXhip)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
