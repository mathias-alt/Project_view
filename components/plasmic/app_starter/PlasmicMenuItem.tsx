...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: K31fiPF1Jm05/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__nEyCh)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__kzWz6)}>
            <div
              className={classNames(
                projectcss.all,
