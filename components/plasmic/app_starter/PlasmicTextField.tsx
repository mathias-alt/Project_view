...
import Label from "../../Label"; // plasmic-import: 2nmKpoYLZwJl/component
import TextInput from "../../TextInput"; // plasmic-import: bzVVRVlwzt8y/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: hgN9yiL_lFqR/component
import Description from "../../Description"; // plasmic-import: wTlSqq8n_EhH/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: 9MTWWu5mIAvl/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vh6Rm, {
          [sty.freeBoxiconEnd__vh6RmP4Wjd]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__vh6RmvYZxw]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__vh6RmtaIep]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__moDc, {
            [sty.freeBoxiconStart__moDCvYZxw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__moDCtaIep]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__eJGo4)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ofhxt, {
            [sty.freeBoxiconEnd__ofhxtp4Wjd]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ofhxTvYZxw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__oeJlp)}
                role={"img"}
              />
            ),
