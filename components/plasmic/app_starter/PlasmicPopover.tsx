...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: AITvL4GkHRYR/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: dJxmX5RArcAO/css
  ...
  return (
    <BaseDialogTrigger
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(projectcss.all, sty.freeBox___7NnHz)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__yiErl)}
            label={"Open Popover"}
          />
        ),
