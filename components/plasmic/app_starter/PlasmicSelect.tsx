...
import MenuPopover from "../../MenuPopover"; // plasmic-import: Gd8mao9bbWq_/component
import MenuItem from "../../MenuItem"; // plasmic-import: K31fiPF1Jm05/component
import MenuSection from "../../MenuSection"; // plasmic-import: hx5Ocsh5TuMb/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: lFSTpiC5geYc/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__ero9S)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
