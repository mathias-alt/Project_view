...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: jrD-Cp6Lw-Zh/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: lNPAiYlItVGb/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: 8ooBLhdP8P6w/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__r2HNu)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg___66Blt)}
            role={"img"}
          />
        ) : null}
      </div>
