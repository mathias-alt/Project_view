...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: Y5vJR3YQjrZq/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__uIdqY)}>
        <div className={classNames(projectcss.all, sty.freeBox__zD79U)} />
      </div>
      {renderPlasmicSlot({
